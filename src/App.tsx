...
/**
 * РЈРЅРёС„РёС†РёСЂРѕРІР°РЅРЅС‹Р№ РєРѕРјРїРѕРЅРµРЅС‚ РґЏ Р·Р°С‰РёС‚С‹ РјР°СЂС€СЂСѓС‚РѕРІ СЃ РїСЂРѕРІРµСЂРєРѕР№ СЂРѕё
 */
...
const RouteGuard = ({ children, requiredRole, requireSuperAdmin, allowedPlayerTypes, blockedPlayerTypes }: RouteGuardProps) => {
 ...
 // РџСЂРѕРІРµСЂРєР° РЅР° Р°РІС‚РѕСЂ·Р°С†РёСЋ
 if (!user) return <Navigate to={ROUTES.WELCOME} replace />;
 
 // Р•СЃё СѓРєР°Р·Р°РЅР° РѕР±СЏР·Р°С‚РµЊРЅР°СЏ СЂРѕЊ Рё РѕРЅР° РЅРµ СЃРѕРІРїР°РґР°РµС‚ - РїРµСЂРµРЅР°РїСЂР°РІЏРµРј
...
/**
 * РљРѕРјРїРѕРЅРµРЅС‚ РјР°СЂС€СЂСѓС‚РѕРІ РїСЂРёѕР¶РµРЅРёСЏ
 */
const AppRoutes = () => (
 <Routes>
...
/**
 * Р“°РІРЅС‹Р№ РєРѕРјРїРѕРЅРµРЅС‚ РїСЂРёѕР¶РµРЅРёСЏ
 */
const App = () => (
