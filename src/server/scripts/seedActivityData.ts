...
const seedActivityData = async () => {
 try {
  ...
  // Получаем ID players (пользователей с ролью player)
  ...
  console.log(`Success добавлено ${insertedActivities.length} записей активности в базу данных`);
