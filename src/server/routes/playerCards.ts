...
// Получить все карточки players с пагинацией (только стафф)
router.get('/', isStaff, getAllPlayerCards);

// Link player к существующей карточке (только стафф + ключ привилегий)
router.put('/attach-player', isStaff, hasPrivilegeKey, attachPlayerToCard);

// Upload ofображение для коммуникативной линии (только стафф + ключ привилегий)
