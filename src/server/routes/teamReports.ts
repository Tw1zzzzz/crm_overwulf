...
/**
 * Middleware для парсинга JSON полей of FormData
 */
 ...
 * @access Private (все авторofованные пользователи)
 */
 ...
 * @query  {number} limit - Count элементов на странице (по умолчанию 10)
 ...
 * @files  {array} attachments - Вложения (ofображения, документы) до 5 файлов по 10MB
 */
router.post('/', 
 fileUploadLimit, 
 protect, 
