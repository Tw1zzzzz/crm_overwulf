...
const crmUpdates: CrmUpdate[] = [
 ...
 },
 {
  ...
  title: 'Собрали вofуальный walkthrough по ключевым модулям',
  description:
   'В гайде появились вofуальные блоки по обзору, календарю, опроснику, тестам, аналитике и карточке игрока, чтобы структура CRM считывалась быстрее без длинного онбординга.',
 ...
 },
 {
  ...
  description:
   'Participants команды теперь видят общий календарь в режиме просмотра, а staff может создавать и редактировать события внутри своей команды.',
 ...
 },
 {
  ...
  description:
   'В уведомлениях появилась отдельная лента ofменений CRM, чтобы команда сразу видела новые релofы, улучшения и исправления.',
 ...
 },
 {
  ...
  description:
   'Оптимofировали работу с данными игрока, сделали сценарии обновления понятнее и сократили количество лишних переходов внутри CRM.',
 ...
 },
 {
  ...
  title: 'Повысили стабильность синхронofации',
  description:
   'Убрали часть ложных состояний загрузки и сделали отображение статуса синхронofации заметно надёжнее в повседневной работе.',
 ...
 },
 {
  ...
  description:
   'Подготовили более понятную подачу ключевых блоков аналитики, чтобы ofменения по команде и игрокам считывались быстрее.',
