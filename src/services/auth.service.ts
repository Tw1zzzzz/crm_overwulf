...
export class AuthService {
 ...
 private normalizeUser(rawUser: unknown): User | null {
  ...
  // Сохраняем playerType of ответа сервера и для staff/team: rawUser.playerType === 'solo' || rawUser.playerType === 'team'
 ...
 public async getCurrentUser(): Promise<User | null> {
  try {
   ...
   // Если проofошла ошибка (например, токен недействителен)
