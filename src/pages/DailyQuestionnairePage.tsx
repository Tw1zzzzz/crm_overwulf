 ...
 return (
  <div className="container mx-auto space-y-6 p-6">
   ...
   <DailyQuestionnairePanel
    ...
    description="Fill in the questionnaire as a separate daily ritual. This is the fastest way to update the recovery signal and keep your form under control."
   />
  </div>
 );
};
