...
const AdvancedAnalytics: React.FC<AdvancedAnalyticsProps> = ({ className }) => {
 ...
 const loadComprehensiveReport = async () => {
  ...
  try {
   ...
   toast({
    title: "Report сгенерирован",
    description: "Comprehensive analysis готов",
   });
  } catch (error) {
   console.error('Error генерации report:', error);
   toast({
    title: "Error",
 ...
 const handleExportComprehensiveReport = async () => {
  try {
   ...
   toast({
    title: "Export complete",
    description: "Comprehensive report аналитики сохранен",
   });
  } catch (error) {
   console.error('Error экспорта report:', error);
   toast({
    title: "Error экспорта",
    description: "Failed to create comprehensive report",
    variant: "destructive",
   });
  }
 };
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
   <Card>
    <CardContent className="pt-6">
     <div className="flex items-center justify-between">
      <div>
       <p className="text-sm font-medium text-gray-600">Analysis сентимента</p>
   ...
   <Card>
    <CardContent className="pt-6">
     <div className="flex items-center justify-between">
      <div>
       <p className="text-sm font-medium text-gray-600">Clusterы players</p>
    ...
    <div className="flex flex-wrap items-center gap-3">
     ...
     <Popover>
      <PopoverTrigger asChild>
       <Button variant="outline" className="w-40 justify-start text-left font-normal">
        ...
        {dateFrom ? format(dateFrom, "dd MMM", { locale: enUS }) : "От даты"}
       </Button>
      </PopoverTrigger>
     ...
     <Popover>
      <PopoverTrigger asChild>
       <Button variant="outline" className="w-40 justify-start text-left font-normal">
        <CalendarIcon className="mr-2 h-4 w-4" />
        {dateTo ? format(dateTo, "dd MMM", { locale: enUS }) : "До даты"}
       </Button>
      </PopoverTrigger>
      <PopoverContent className="w-auto p-0">
       <Calendar
   ...
   <Tabs value={activeTab} onValueChange={(value: any) => setActiveTab(value)} className="w-full">
     ...
     <Card>
      <CardHeader>
       <CardTitle className="flex items-center gap-2">
        ...
        Analysis сентимента reports
       </CardTitle>
      </CardHeader>
      <CardContent>
       <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold">Analysis тональности</h3>
          ...
          <CardContent className="pt-4">
           <div className="space-y-4">
            <div>
             ...
             <p className="text-sm text-gray-600">{cluster.playerIds.length} players</p>
            </div>
     ...
     <Card>
      <CardHeader>
       <CardTitle className="flex items-center gap-2">
        ...
        Time series analysis: {selectedMetric === 'mood' ? 'Mood' : 
      ...
      <CardContent>
        ...
        <Card>
         <CardContent className="pt-4">
          <div className="text-center">
           <p className="text-sm text-gray-600">Type паттерна</p>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
         <CardContent className="pt-4">
          <div className="space-y-2">
           <p className="font-medium">Forecast на неделю</p>
           <div className="flex items-center justify-between">
        ...
        <Card>
         <CardContent className="pt-4">
          <div className="space-y-2">
           <p className="font-medium">Forecast на месяц</p>
           <div className="flex items-center justify-between">
            <span>Ожидаемое значение</span>
         ...
         <Card key={index} className="border-l-4 border-l-yellow-500">
          <CardContent className="pt-4">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
             <p className="text-sm font-medium text-gray-600 mb-2">Influencing factors:</p>
             <div className="space-y-1">
    ...
    <TabsContent value="comprehensive" className="space-y-4">
     <div className="flex items-center justify-between mb-4">
      <h3 className="text-lg font-semibold">Comprehensive аналитический report</h3>
      <Button 
       ...
       <Card>
        ...
        <CardContent className="space-y-6">
         {comprehensiveReport.actionPlan.immediateActions.length > 0 && (
          <div>
           <h4 className="font-medium text-red-600 mb-3">Wedочные действия:</h4>
           <div className="space-y-2">
