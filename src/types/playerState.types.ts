/**
 * Typeы для функции "Состояние игрока"
 */
...
export interface ZoneData {
 ...
 /** Список источников данных, питающих эту зону, напр. ["Внимание: 78", "Reaction: 65"] */
...
export interface PlayerStateReport {
 ...
 /** Список источников данных, использованных при аналofе */
 dataUsed: string[];
 generatedAt: string;
 model: string;
